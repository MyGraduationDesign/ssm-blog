...
<body style="magin:10px">
	<div id="p" class="easyui-panel" data-options="title:'修改个人信息'" style="padding:10px">
		<form id="form1" action="${pageContext.request.contextPath}/admin/user/save.do" method="post" enctype="multipart/form-data">
			<table cellspacing="20px">
				<tr>
					<td width="80px">用户名:</td>
					<td>
						<input type="hidden" id="id" name="id" value="${currentUser.id }"/>
						<input style="width:200px" type="text" id="userName" name="userName" value="${currentUser.userName }" readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<td>昵称:</td>
				...
				<tr>
					...
					<td>
						<script id="proFile" type="text/plain" style="width:80%;height:200px;"></script>	
...
<script type="text/javascript">
	...
	ue.addListener("ready",function(){
		$.get("${pageContext.request.contextPath}/admin/user/find.html",function(result){
	    	result = eval("(" + result + ")");  
	    	//alert(result);
