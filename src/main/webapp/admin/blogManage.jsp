...
<script type="text/javascript">
	...
	function openBlogModifyTab(){
		 ...
		 window.parent.openTab('修改博客','editBlog.jsp?id='+row.id,'icon-writeblog');
	}
</script>
</head>
<body style="margin: 1px">
	<table id="dg"
		data-options="title:'博客管理',fitColumns:true,pagination:true,rownumbers:true,fit:true,toolbar:'#tb',
